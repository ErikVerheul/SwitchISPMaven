...
class Globals {
    ...
    protected static final long DEFAULT_TRIGGERDURATION_IN_SEC = 30L;
    protected static final long DEFAULT_RETRYINTERVAL_IN_SEC = 300L;
    protected static final int DEFAULT_MAXRETRIES = 5;
    protected static final int PRIMARY_ISP = 0;
    protected static final int BACKUP_ISP = 1;
